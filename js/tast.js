...
if (window.location.hostname !== "maz.qzz.io") {
  document.body.innerHTML = "<h1 style='color:red;text-align:center;padding-top:50px;'>Access Denied</h1>";
...
async function sendMessage() {
    ...
    try {
        ...
        addMessage("Error: Connection issue. Please try again later.", 'ai');
